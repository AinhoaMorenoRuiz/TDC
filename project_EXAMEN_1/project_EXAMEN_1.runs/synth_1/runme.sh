...
HD_PWD='C:/Users/ainho/project_EXAMEN_1/project_EXAMEN_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EJ1_N_BITS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EJ1_N_BITS.tcl
